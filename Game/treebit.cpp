...
TreeBit::TreeBit(int _levels, int _perLevel, int _ofLevel, float _scale, Vector3 _shift, float _lean, string _bitFileName, ID3D11Device* _pd3dDevice, std::shared_ptr<IEffectFactory> _EF, TreeBit* _parent, list<TreeBit*>* _tree) :CMOGO(_bitFileName, _pd3dDevice, _EF)
{
	m_parent = _parent;
