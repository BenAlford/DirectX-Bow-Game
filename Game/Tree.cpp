...
Tree::Tree(int _levels, int _perLevel, float _scale, Vector3 _shift, float _lean, string _bitFileName, ID3D11Device* _pd3dDevice, std::shared_ptr<IEffectFactory> _EF)
{
